...
public class EnchantmentContainer {
     ...
     *         The enchantments.
     * @param plugin
     *         The {@link ArmoredElytra} instance to use for obtaining the list of allowed enchantments. See
     ...
     *         The item.
     * @param plugin
     *         The {@link ArmoredElytra} instance to use.
     *
     ...
     *
     * @param first
     *         The first enchantment container.
     * @param second
     *         The second enchantment container. In case of conflicts, this will take precedence.
     *
     ...
     *
     * @param first
     *         The first maps of enchantments.
     * @param second
     *         The second maps of enchantments. In case of conflicts, this will take precedence.
     *
     * @return The new map of enchantments.
     */
     ...
     *
     * @param allowed
     *         The names of enchantments (upper case) that are allowed. Any names not in this list are removed.
     */
     ...
     *
     * @param is
     *         The itemstack to apply the enchantments to.
     */
